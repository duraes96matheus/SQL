...
insert into tb_hardware(descricao,preco,qtde,qtde_mini)
values('Memória Rom do inglês “Read-Only Memory“, estas memórias são apenas de leitura, ou seja, as informações que elas contiverem são gravadas apenas em uma única vez e ficam lá para sempre','150.00','50','25')
insert into tb_hardware(descricao,preco,qtde,qtde_mini)
values('Chipsete O Chipset é um dos componentes lógicos da placa-mãe que permite controlar outros componentes e periféricos. Divide-se em duas pontes: a norte (northbridge, controlador de memória, alta velocidade) e a sul (southbridge, controlador de periféricos, baixa velocidade','100.00','50','20')
insert into tb_hardware(descricao,preco,qtde,qtde_mini)
values('Bateria faz a alimentação do circuito CMOS para que alimente a data (dia, ano e mês) e hora da placa-mãe e/ou outras alterações da BIOS.','5.0','40','10')
insert into tb_hardware(descricao,preco,qtde,qtde_mini)
values('Disco rígido ou popularmente chamado de HD (do inglês Hard Disk Drive) é o componente do computador onde são gravados e armazenados os dados. Trata-se de uma memória não-volátil, pois quando o computador for desligado, as informações não serão perdidas, tal como acontece com as memórias RAM.','300.00','30','15')
insert into tb_hardware(descricao,preco,qtde,qtde_mini)
values('A placa gráfica, também chamada de placa de vídeo, é o componente do computador que vai enviar as imagem para o ecrã (tela), de maneira a que sejam apresentadas as imagens para o utilizador.','250.00','20','15')
